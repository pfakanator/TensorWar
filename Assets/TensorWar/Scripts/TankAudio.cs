...
namespace TensorWar
{
    ...
    public class VehicleAudio : MonoBehaviour
    {
        ...
        AudioSource m_HighAccel; // Source for the high acceleration sounds
        AudioSource m_HighDecel; // Source for the high deceleration sounds

        AudioSource m_LowAccel; // Source for the low acceleration sounds
        AudioSource m_LowDecel; // Source for the low deceleration sounds
        bool m_StartedSound; // flag for knowing if we have started sounds
        VehicleController m_VehicleController; // Reference to car we are controlling
        ...
        void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_VehicleController.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_VehicleController.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_VehicleController.Revs);
        ...
        void StartSound()
        {
            // get the VehicleController ( this will not be null as we have require component)
